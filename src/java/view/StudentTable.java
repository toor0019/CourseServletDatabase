...
public class StudentTable extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>StudentView</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            out.println("<caption>Student</caption>");
            out.println("<tr>");
            ...
            for (Student student : students) {
                out.printf("<tr><td>%s</td><td>%s</td><td>%s</td></tr>", student.getID(), student.getFirstName(),student.getLastName());
            }
