...
public class GroupUpdate extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>GroupUpdate</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<div style=\"text-align: center;\">");
            out.println("<div style=\"display: inline-block; text-align: left;\">");
            out.println("<form action=\"GroupUpdate\" method=\"post\">");
            out.println("Group ID:<br>");
            out.printf("<input type=\"text\" name=\"%s\" value=\"\"><br>",Group.COL_ID);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        deleteGroup = ()->{
            ...
            try{
                logic.deleteGroup( request.getParameterMap().get(Group.COL_ID)[0]);
