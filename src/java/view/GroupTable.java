...
public class GroupTable extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>GroupView</title>");            
            out.println("</head>");
            out.println("<body>");
            
            GroupLogic logic = new GroupLogic();
            List<Group> students = logic.getAllGroups();
            out.println("<table align=\"center\" border=\"1\">");
            out.println("<caption>Group</caption>");
            out.println("<tr>");
           ...
           int i=1;
            for (Group student : students) {
                out.printf("<tr><td>%s</td><td>%s</td></tr>",student.getId(),student.getName());
            }
